...
keep_vars = ['O3','U','V','T','TS','TREFHT','Q','PSL','PRECC','PRECL','PRECSC','PRECSL','Z3','TCO','OMEGA','FLNT','CLDICE','U10','V10','CLDTOT','FLDS','FSDS','FLDSC','FSDSC','LWCF','SWCF','ICEFRAC','QRS','QRL']
#keep_vars = ['FSDSC','FLDSC']
#keep_vars = []
